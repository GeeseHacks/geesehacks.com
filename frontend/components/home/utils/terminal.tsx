...
const AnimatedTerminal: React.FC = () => {
  ...
  return (
    <div className="relative bg-black bg-opacity-85 text-white p-8 pt-16 font-mono flex flex-col h-80 rounded-xl w-[calc(35vw)] md:text-sm lg:text-base shadow-terminal-glow1">
      {/* First line */}
