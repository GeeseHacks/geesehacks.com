...
export default function Footer() {
  return (
    <div className="flex flex-col items-center justify-around p-6 px-16">
      ...
      <div className="flex flex-row items-center justify-between w-full pb-7">
        <div className="flex flex-col text-white gap-3 basis-1/2">
          <h1 className="text-2xl font-bold">The Organizing Team</h1>
          <p className="text-sm">Contact us at geesehack@gmail.com</p>
        </div>
          <Carousel />
      </div>
