    ...
    <div className="p-8 sm:p-16 flex flex-col items-center justify-center bg-gray-600">
      ...
      <div className="w-full sm:w-3/4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex justify-center items-center bg-purple-200 bg-opacity-25 border border-purple-600 rounded-md p-4 min-h-[6rem] hover:scale-105 ease-in-out duration-300">
            <img
