...
export default function Partners() {
  return (
    <div className="p-8 sm:p-16 flex flex-col items-center justify-center relative">
      ...
      <div className="absolute w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-purple-600 rounded-full blur-2xl opacity-40" style={{ top: '30%' }}></div>
      <div className="w-full sm:w-3/4 z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex justify-center items-center bg-purple-300 bg-opacity-15 border border-purple-300 rounded-md p-4 min-h-[6rem] hover:scale-105 ease-in-out duration-300">
            <img
