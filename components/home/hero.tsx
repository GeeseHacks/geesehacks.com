...
const Hero = () => {
  return (
    <>
      ...
      <div
        className="bg-cover bg-center w-full h-screen flex items-center justify-center md:justify-evenly"
        style={{ backgroundImage: `url(${backgroundImage.src})`, backgroundSize: 'cover', backgroundAttachment: 'fixed' }}
