...
const Hero = () => {
  return (
    ...
    <Head>
      ...
      <div className="bg-cover w-full h-screen flex items-center justify-center md:justify-evenly bg-bottom" style={{ backgroundImage: `url("/images/heroBackground.png")` }} aria-label="Hero section">
