...
const AnimatedTerminal: React.FC = () => {
  ...
  return (
    // Note: Commented out shadow-terminal-glow1 in the following classname
    <div className="relative bg-black bg-opacity-85 text-white p-8 pt-16 font-mono flex flex-col h-80 rounded-xl w-[calc(35vw)] md:text-sm lg:text-base max-w-[600px]"> 
      {/* First line */}
