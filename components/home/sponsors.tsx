...
const SponsorCard: React.FC<SponsorCardProps> = ({ href, src, alt, width }) => {
  return (
    <a
      ...
      className="flex"
    >
      <div className="flex justify-center items-center bg-gradient-to-br from-purple-600/30 to-indigo-300/30 border-0 border-purple-300 rounded-2xl p-12 min-h-[10rem] hover:scale-102 ease-in-out duration-300 w-full">
